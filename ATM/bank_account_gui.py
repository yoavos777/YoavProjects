...
class BankAccountWindow(object):
    def __init__(self, master):
        ...
        self._deposit_account_name.place(bordermode=OUTSIDE, height=20, width=200, x=50, y=30)
        self._deposit_button = Button(master, text='deposit money to your account', command=self.deposit)
        self._deposit_button.pack()
        self._deposit_button.place(bordermode=OUTSIDE, height=20, width=200, x=50, y=80)
        self._text_box = Text(master)
        self._text_box.pack()
        self._text_box.place(bordermode=OUTSIDE, height=20, width=200, x=50, y=130)

        self._withdraw_account_name = Entry(master, text='amount of money2')
        self._withdraw_account_name.pack()
        self._withdraw_account_name.place(bordermode=OUTSIDE, height=20, width=200, x=500, y=30)
        ...
        self._withdraw_button.place(bordermode=OUTSIDE, height=20, width=200, x=500, y=80)
        self._text_box2 = Text(master)
        self._text_box2.pack()
        self._text_box2.place(bordermode=OUTSIDE, height=20, width=200, x=500, y=130)

        self._get_name_button = Button(master, text='click here to see your name', command=self.get_name)
        self._get_name_button.pack()
        self._get_name_button.place(bordermode=OUTSIDE, height=20, width=200, x=950, y=30)
        self._text_box3 = Text(master)
        self._text_box3.pack()
        self._text_box3.place(bordermode=OUTSIDE, height=20, width=200, x=950, y=80)
        ...
        self._get_balance_button.place(bordermode=OUTSIDE, height=20, width=200, x=275, y=230)
        self._text_box4 = Text(master)
        self._text_box4.pack()
        self._text_box4.place(bordermode=OUTSIDE, height=20, width=200, x=275, y=280)

        self._get_number_button = Button(master, text='click here to see your number')
        self._get_number_button.pack()
        self._get_number_button.place(bordermode=OUTSIDE, height=20, width=200, x=725, y=230)
        self._text_box5 = Text(master)
        self._text_box5.pack()
        self._text_box5.place(bordermode=OUTSIDE, height=20, width=200, x=725, y=280)
