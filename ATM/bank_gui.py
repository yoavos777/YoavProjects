...
class BankWindow(object):
    def __init__(self, master):
        ...
        self._new_account_name.place(bordermode=OUTSIDE, height=20, width=100, x=50, y=30)
        ...
        self._create_account_button.place(bordermode=OUTSIDE, height=20, width=100, x=50, y=80)
        self._text_box2 = Text(master)
        self._text_box2.pack()
        self._text_box2.place(bordermode=OUTSIDE, height=20, width=200, x=50, y=130)

        self._delete_account_name = Entry(master, text='delete account')
        self._delete_account_name.pack()
        self._delete_account_name.place(bordermode=OUTSIDE, height=20, width=100, x=350, y=30)
        ...
        self._delete_account_button.place(bordermode=OUTSIDE, height=20, width=100, x=350, y=80)
        self._text_box3 = Text(master)
        self._text_box3.pack()
        self._text_box3.place(bordermode=OUTSIDE, height=20, width=200, x=350, y=130)
        ...
        self._all_account_button.place(bordermode=OUTSIDE, height=20, width=200, x=650, y=30)
        self._text_box4 = Text(master)
        self._text_box4.pack()
        self._text_box4.place(bordermode=OUTSIDE, height=500, width=590, x=650, y=80)

        self._open_account_window = Entry(master, text='open account')
        self._open_account_window.pack()
        self._open_account_window.place(bordermode=OUTSIDE, height=20, width=100, x=200, y=230)
        ...
        self._open_account_window_button.place(bordermode=OUTSIDE, height=20, width=100, x=200, y=330)
