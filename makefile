...
EXEC_FILE = firstTransition
C_FILES = main.c firstTransition.c secondTransition.c constTables.c auxFuncs.c
H_FILES = firstTransition.h secondTransition.h constTables.h
